...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/Users/andy/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20configs.Comment\frequire\0" },
    keys = { { "", "gc" }, { "", "gb" }, { "", "g<" }, { "", "g>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  ["FixCursorHold.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/FixCursorHold.nvim",
  ...
  LuaSnip = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["bufdelete.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/bufdelete.nvim",
  ...
  ["cinnamon.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/cinnamon.nvim",
    url = "https://github.com/declancm/cinnamon.nvim"
  },
  ["cmp-buffer"] = {
    after_files = { "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    after_files = { "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-path"] = {
    after_files = { "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    after_files = { "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
    url = "https://github.com/saadparwaiz1/cmp_luasnip"
  },
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["indent-o-matic"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/indent-o-matic",
  ...
  ["lualine.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/lualine.nvim",
  ...
  ["neo-tree.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/neo-tree.nvim",
  ...
  ["nui.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nui.nvim",
  ...
  ["null-ls.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/null-ls.nvim",
    url = "https://github.com/jose-elias-alvarez/null-ls.nvim"
  },
  ["nvim-base16"] = {
    loaded = true,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/start/nvim-base16",
  ...
  ["nvim-cmp"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-notify"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-notify",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["nvim-ts-context-commentstring"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-ts-context-commentstring",
  ...
  ["nvim-ts-rainbow"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ["smart-splits.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/smart-splits.nvim",
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",
  ...
  ["telescope.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/opt/telescope.nvim",
    url = "https://github.com/nvim-telescope/telescope.nvim"
  },
  ["vscode.nvim"] = {
    loaded = true,
    path = "/Users/andy/.local/share/nvim/site/pack/packer/start/vscode.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'null-ls.nvim', 'cinnamon.nvim', 'nvim-treesitter', 'FixCursorHold.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'null-ls.nvim', 'cinnamon.nvim', 'nvim-treesitter', 'FixCursorHold.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
